...
namespace CS_Use_DLL
{
    ...
    {
        //
        // NOTE: dllEdge.dll and WebView2Loader.dll must be in the same directory as the executable
        //
        [DllImport("dllEdge.dll", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        //
        ...
        [DllImport("dllEdge.dll")] public static extern int StopEdge(int timeOut = 2000);
        [DllImport("dllEdge.dll")] public static extern int Navigate([MarshalAs(UnmanagedType.LPStr)] string url, int timeOut = 5000);
        [DllImport("dllEdge.dll")] public static extern int CS_RunJavascript([MarshalAs(UnmanagedType.LPStr)] string javascript, StringBuilder jsResult, int maxLen, int timeOut = 2000);
        [DllImport("dllEdge.dll")] public static extern int MsgBox([MarshalAs(UnmanagedType.LPStr)] string message);
        [DllImport("dllEdge.dll")] public static extern int Get_hWnd();
        //
        // Javascript
        //
