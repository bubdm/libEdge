////////////////////////////////////////////////////////////////////////////////////////////
// Example of how to use libEdge / dllEdge in C++
//
#include <windows.h>
#include <string>
//
//#define USEDLL // Comment out to use the static lib (recommended for C++ usage)
//
...
//
#ifdef USEDLL 
#include "dllEdge.h"	// Include for DLL 
#ifdef _DEBUG
#pragma message("Runtime library must be set to Multithreaded Debug DLL")
#ifdef _WIN64
#pragma comment(lib, R"(..\x64\Debug\dllEdge.lib)")
#else // Win32
#pragma comment(lib, R"(..\x86\Debug\dllEdge.lib)")
#endif
#else // Release
#pragma message("Runtime library must be set to Multithreaded DLL")
#ifdef _WIN64
#pragma comment(lib, R"(..\x64\Release\dllEdge.lib)")
#else // Win32
#pragma comment(lib, R"(..\x86\Release\dllEdge.lib)")
#endif
#endif
#else
//
...
#include "libEdge.h"
#ifdef _DEBUG
#pragma message("Runtime library must be set to Multithreaded Debug (no DLL)")
#ifdef _WIN64
...
#endif
#else // Release
#pragma message("Runtime library must be set to Multithreaded (no DLL)")
#ifdef _WIN64
